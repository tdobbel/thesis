...
\begin{figure}
    \centering
    \includegraphics[width=.8\textwidth]{figures/anthropocene.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.9\textwidth]{figures/cover.jpeg}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/sctld.jpg}
...
\begin{list}{}{%
    ...
    \item \textbf{DRTO}: Dry Tortugas
    \item \textbf{ECMWF}: 
    \item \textbf{FCR}: Florida's Coral Reef
    \item \textbf{FRT}: Florida Reef Tract 
    \item \textbf{NOAA}: National Oceanographic and Atmospheric Administration
    \item \textbf{PoM}: Port of Miami
    \item \textbf{PMDDP}: PortMiami Deep Dredge Project
    \item \textbf{SCTLD}: Stony coral tissue loss disease
\end{list}
