...
%%
%%%%%% 
\mychapter{The mechanisms of the spread of SCTLD in Florida} \label{chap:sctld}
\chaptermark{Modeling the spread of SCTLD in Florida}  
\input{chapters/sctld/sctld}
\mychapter{The apparent stalling of the spread of SCTLD in the Marquesas}\label{chap:drto}
...
\mychapter{The impacts of hurricanes on transport processes in the Florida Keys} \label{chap:irma}
