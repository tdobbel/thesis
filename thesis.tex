...
\mychapter{Impacts of hurricanes on wave-induced ocean transport
processes} \label{chap:irma}
\chaptermark{Wave-induced transport under hurricanes}  
\input{chapters/irma/irma}
%%
% \mychapter{Paper Dry Tortugas} \label{chap:ontario}
% \chaptermark{Paper DRTO}  
%   \input{chapters/ontario/ontario}
%
% \mychapter{Paper onset} \label{chap:eigenmode}
% \chaptermark{Paper onset}  
%   \input{chapters/eigenmode/eigenmode}
%%%   
%%%%%%%%%%%
%
%%%%%  
