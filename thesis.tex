...
%%
%%%%%% 
\mychapter{Processes driving the spread of SCTLD through the FRT} \label{chap:sctld}
\chaptermark{Processes driving the spread of SCTLD in the FRT}  
\input{chapters/sctld/sctld}
\mychapter{Transmission dynamics of SCTLD from the Marquesas and to the DRTO}\label{chap:drto}
